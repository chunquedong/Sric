...
public class Token {
    ...
    public static enum TokenKind {
        ...
        isKeyword("is", true),
        itKeyword("it", true),
        mixinKeyword("mixin", true),
        nativeKeyword("native", true),
        newKeyword("new", true),
