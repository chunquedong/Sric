...
class FuncTypeDef : Node {
  ...
  TypeRef mostSpecific(TypeRef b, Bool inferredSignature)
  {
    a := this.typeRef
  ...
  private static TypeRef toMostSpecific(TypeRef a, TypeRef b)
  {
    //if (b.hasGeneriParamDefeter) return a
...
//    this.ctype            = signature
  ...
  Expr toWith(Expr target, MethodDef with, CNamespace ns)
  {
  ...
  Void setInferredSignature(TypeRef t, CNamespace ns)
  {
