...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ...
  private SlotDef? findOn(TypeRef base)
  {
    ...
    // for field.call(...)
    if (found is FieldDef && !isVar)
    {
      field := (FieldDef)found
      if (field.fieldType.isFunc)
        isFunFieldDefCall = true
      else
  ...
  private Void findInheritedStatic(TypeRef type, SlotDef[] founds) {
  ...
  private Bool findExtesion(TypeRef base) {
    ...
    meths.each |m| {
      ...
      TypeRef paramType := param.paramType
  ...
  private Bool isAmbiguous(SlotDef? onBase, SlotDef? onIt)
  {
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ...
  {
    if (found is FieldDef)
    {
      result = resolveToFieldExpr
      if (isFunFieldDefCall)
      {
        callMethod := ((FieldDef)found).fieldType.method("call")
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  static Expr inferClosureTypeFromCall(CompilerContext support, CallExpr call, TypeRef base)
  {
    ...
    if (lastC != null && lastC.isItBlock) lastC.followCtorType = base
...
//////////////////////////////////////////////////////////////////////////
  ...
  Bool isFunFieldDefCall // is this a field.call(...) on func field
  Expr[] args          // arguments or null if simple variable
  TypeRef? base          // resolveBase()
  TypeRef? baseIt        // resolveBase()
  SlotDef? found         // find()
